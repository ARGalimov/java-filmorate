...
public class ValidateTest {
    ...
    void testFilmIsCreatedBefore() {
        ...
        ValidationException exception = assertThrows(
                ValidationException.class,
                () -> FilmController.validateFilmCreation(films, film)
        );
    ...
    void testFilmIsNotCreatedBefore() {
        ...
        ValidationException exception = assertThrows(
                ValidationException.class,
                () -> FilmController.validateFilmUpdate(films, film)
        );
    ...
    void validateUserUpdate() {
        ...
        Map<Integer, User> users = new HashMap<>();
        ValidationException exception = assertThrows(ValidationException.class,
                ()-> UserController.validateUserUpdate(users, user));
